...
# Adding a new row without manually specifying the ID
new_data = ['Jacob', 29, 72000, 'Gold Coast', 4]

# Load the existing CSV data to get the current IDs
...
# Combine the new ID with the new data
new_row = [new_id] + new_data
